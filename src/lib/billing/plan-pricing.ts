...
export const PLAN_PRICING: Record<PlanKey, PlanPricing> = {
  starter: {
    ...
    highlights: [
      ...
      "Documentos (4 GB) y firma electrónica",
      "Canal de denuncias (Ley 2/2023)",
      "Comunicados y base de conocimiento",
  ...
  pro: {
    ...
    highlights: [
      ...
      "Objetivos (OKRs) y evaluaciones de desempeño",
      "Encuestas de clima laboral",
      "Formación (LMS) y peticiones personalizadas",
      "Control de gastos y reserva de espacios",
      "Envío de nóminas + prenómina exportable",
      "Retribución flexible (tickets, guardería, transporte)",
      "Chat interno + marketplace de integraciones",
      "Multi-empresa (varios CIFs)",
      "Notificaciones push",
